		...
		<div>
		 <h2>Background and Instructions</h2>
		<p>The xkcd Password Generator is design to people not only create a very strong password but 
			also as memory aid by using those cartoon characters. I use the same principal to create my XKCD 
			Password Generator. I used good old and memorable American to generate my password and strengthen 
			by a randomized series of numbers and symbols. I also capitalized every first letter of the proverb string.</p>
