		...
		<hr>
			...
			<form action="index.php" method="post"> <!--Post collect all the use inputs values to be processed of the input values back into the page-->
	           ...
	           <fieldset>
		                ...
		                <input type='checkbox' name='firstL_cap' id='firstL_cap' CHECKED> <!--Checbox to add numerical value to password -->          
					
						<br>
					
						<label for='add_number'>Add Numbers</label>
						<input type='checkbox' name='add_number' id='add_number' CHECKED> <!--Checbox to add numerical value to password -->
					
						<br>
				
						<label for='add_symbol'>Add Symbols</label>
						<input type='checkbox' name='add_symbol' id='add_symbol' CHECKED> <!--Checbox to add special symbol to password -->
